...
class StoryList {
  ...
  // remove story from api and story list
...
class User {
  ...
  // remove story from favorites and api
  ...
  // update api of favorite/not favorite
  ...
  // return true/false if give story instance of favorites
